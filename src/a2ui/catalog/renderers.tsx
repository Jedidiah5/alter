      ...
      <div className="alt-psyche__stress">
        ...
        <div className="alt-psyche__bar">
          <div
            ...
            style={{
              width: `${Math.min(100, Math.max(0, props.stress))}%`,
            }}
          />
        </div>
...
const TensionMeter = ({
  ...
  return (
    <div className="alt-tension" style={{ ["--alt-accent" as string]: color }}>
      <div className="alt-tension__top">
        <span>TENSION</span>
        {props.label && (
          <span className="alt-tension__label">{props.label}</span>
        )}
